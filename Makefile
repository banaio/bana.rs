...
export PATH															:= $(shell echo ${HOME}/.cargo:${HOME}/.cargo/bin:${PATH})
export NAME_REPO												:= github.com/banaio/bana.rs
...
.PHONY: node_modules_upgrade_all
node_modules_upgrade_all:
	$(print_separator)
...
.PHONY: debug_env
debug_env: VARS_BUILD:=NAME_REPO PATH VERBOSE DIR_FULL_PATH DIR_NAME
debug_env:
	$(print_separator)
